...
declare -a tests=(
"VAR testfiles/test_case_cat.txt"
)

declare -a extra=(
"-s testfiles/test_1_cat.txt"
"-b -e -n -s -t -v testfiles/test_1_cat.txt"
"-t testfiles/test_3_cat.txt"
"-n testfiles/test_2_cat.txt"
"no_file.txt"
"-n -b testfiles/test_1_cat.txt"
"-s -n -e testfiles/test_4_cat.txt"
"testfiles/test_1_cat.txt -n"
"-n testfiles/test_1_cat.txt"
"-n testfiles/test_1_cat.txt testfiles/test_2_cat.txt"
"-v testfiles/test_5_cat.txt"
)
